...
CREATE INDEX IF NOT EXISTS idx_system_metrics_details ON system_metrics USING GIN(details jsonb_path_ops);
...
CREATE INDEX IF NOT EXISTS idx_system_health_request_context ON system_health USING GIN(request_context jsonb_path_ops);
CREATE INDEX IF NOT EXISTS idx_system_health_response_context ON system_health USING GIN(response_context jsonb_path_ops);
...
CREATE INDEX IF NOT EXISTS idx_system_alerts_alert_data ON system_alerts USING GIN(alert_data jsonb_path_ops);
